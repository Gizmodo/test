    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/gizmodo/test/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/gizmodo/test.git")
                    developerConnection.set("scm:git:ssh://github.com/gizmodo/test.git")
                    url.set("https://github.com/gizmodo/test/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/gizmodo/test/issues")
                }
            }
        }
    }
